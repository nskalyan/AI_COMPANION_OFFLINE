...
1) Clone the repository- git clone https://github.com/nskalyan/AI_COMAPNION_OFFLINE
...
2) open new terminal and type  cd companion_flutter
3) flutter pub get
4) flutter devices  # here verify your device name is there and verified if not verified accept rsa in your when we connect via usb
5) flutter run
